...
# with command line options: step1 --filein file:test_sSUSY_AODSIM.root --fileout file:test_sSUSY_MINIAOD.root --mc --eventcontent MINIAODSIM --runUnscheduled --datatier MINIAODSIM --conditions 80X_mcRun2_asymptotic_2016_TrancheIV_v6 --step PAT --nThreads 4 --era Run2_2016 --python_filename test_sSUSY_AODSIMtoMINIAOD_cfg.py --no_exec --customise Configuration/DataProcessing/Utils.addMonitoring -n 100
